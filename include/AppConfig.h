...
constexpr uint8_t kMaxConsecutiveFastestRefreshes = 2;
constexpr uint8_t kMaxFastRefreshesBeforeCleanup = 5;
constexpr uint8_t kMaxReadingRefreshesBeforeQuality = 6;
constexpr uint32_t kMaxMillisecondsWithoutQualityRefresh = 5UL * 60UL * 1000UL;
constexpr size_t kReaderInputChunkSize = 1024;
constexpr size_t kReaderInputBufferChunks = 1;
constexpr size_t kMaximumInlineImageBytes = 2 * 1024 * 1024;
constexpr size_t kMaximumInlineImagesPerPage = 4;
